...
<head>
	...
	<title>Ruta Inmobiliaria - Detalle Noticia</title>
...
<!-- End Google Tag Manager -->
	...
	<link rel="alternate" type="application/rss+xml" title="Realtor - Responsive Real Estate WordPress Theme &raquo; Sweet home for your sweet family Comments Feed"
	 href="http://premiumlayers.net/demo/wp/realtor/sweet-home-for-your-sweet-family-2/feed/" />
	...
	<link rel='prev' title='Sweet home for your sweet family' href='sweet-home-for-your-sweet-family/index.html' />
	<link rel='next' title='Sweet home for your sweet family' href='sweet-home-for-your-sweet-family-3/index.html' />
	<meta name="generator" content="WordPress 4.8.7" />
	<link rel='shortlink' href='http://premiumlayers.net/demo/wp/realtor/?p=133' />
	<link rel="alternate" type="application/json+oembed" href="http://premiumlayers.net/demo/wp/realtor/wp-json/oembed/1.0/embed?url=http://premiumlayers.net/demo/wp/realtor/sweet-home-for-your-sweet-family-2/"
	/>
	<link rel="alternate" type="text/xml+oembed" href="http://premiumlayers.net/demo/wp/realtor/wp-json/oembed/1.0/embed?url=http://premiumlayers.net/demo/wp/realtor/sweet-home-for-your-sweet-family-2/&format=xml"
	/>
...
<body class="post-template-default single single-post postid-133 single-format-standard customize-support wpb-js-composer js-comp-ver-5.1.1 vc_responsive">
		...
		<div class="sub-banner">
			<div class="overlay">
				<div class="container">
					...
					<ol class="breadcrumb">
						<li class="pull-left">Detalle Noticia</li>
						<li><a href="index.html">Inicio</a></li>
						<li><a href="noticias.php">Blog</a></li>
						<li>Detalle Noticia</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class=" col-md-12 col-sm-12 col-xs-12">
						...
						<div class="single-post" id="notice-info">
							<!--======= CLIENTS FEEDBACK =========-->
...
/* ]]> */
    ...
    <script>
        var imagen = 'http://rutainmobiliaria.co/ruta-noticias/admin/'+imagen+'';

        imagen = imagen.replace(/\s/g, '');

        var noticia =   '<div class="blog-page">'+
					'<section class="blog no-padding">'+
					'<ul class="row">'+
					'<li class="col-sm-12 single_item">'+
					'<div class="b-inner">'+
					'<img width="867" height="430" src="'+imagen+'" class="img-responsive wp-post-image" alt="" /> <div class="b-details">'+
					'<div class="bottom-sec"> <span><i class="fa fa-calendar-alt"></i>'+dia+'/'+mes+'/'+anio+'</span> <a class="font-montserrat" href="#">'+titulo+'</a> </div>'+
					'</div>'+
					'</div>'+	
					'<p>'+descripcion+'</p>'+
					'</li>'+
